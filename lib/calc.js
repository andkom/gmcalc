(() => {
  ...
  function calculate() {
    ...
    try {
      ...
      if (resultUrs) resultUrs.textContent = formatNumber(urs, 5);
      if (resultUrh) resultUrh.textContent = formatNumber(urh, 5);
      if (resultUsvs) resultUsvs.textContent = formatNumber(usvs, 5);
      if (resultUsvh) resultUsvh.textContent = formatNumber(usvh, 5);
      if (resultCps) resultCps.textContent = formatNumber(cps, 5);
      if (resultCpm) resultCpm.textContent = formatNumber(cpm, 5);
      if (resultCpmToUrh) resultCpmToUrh.textContent = formatNumber(cpm / urh, 5);
      if (resultCpmToUsvh) resultCpmToUsvh.textContent = formatNumber(cpm / usvh, 5);
      if (resultCpmToUrs) resultCpmToUrs.textContent = formatNumber(cpm / urs, 5);
      if (resultCpmToUsvs) resultCpmToUsvs.textContent = formatNumber(cpm / usvs, 5);
      if (resultCpsToUrh) resultCpsToUrh.textContent = formatNumber(cps / urh, 5);
      if (resultCpsToUsvh) resultCpsToUsvh.textContent = formatNumber(cps / usvh, 5);
      if (resultCpsToUrs) resultCpsToUrs.textContent = formatNumber(cps / urs, 5);
      if (resultCpsToUsvs) resultCpsToUsvs.textContent = formatNumber(cps / usvs, 5);
      if (resultCpsTo10Usv) resultCpsTo10Usv.textContent = formatNumber(cps * 10. / usvh, 5);
      if (resultCpsPerUrs) resultCpsPerUrs.textContent = formatNumber(cps / urs, 5);
    } catch (err) {
